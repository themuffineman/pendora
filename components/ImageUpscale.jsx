    ...
    <div className='w-full p-2 flex flex-col gap-1'>
        <div className='flex flex-col gap-1 w-full'>
            ...
            <div className='flex justify-between items-center w-full'>
                ...
                <input value={upscaleIntensity} onChange={(e)=> setUpscaleIntensity(e.target.value)} type="number" className="w-16 h-8 appearance-none focus:outline-white outline-1 bg-black text-white rounded-md p-2"/>
            </div>
        </div>
        <div className='flex flex-col gap-1 w-full'>
            ...
            <div className='flex justify-between items-center w-full'>
                ...
                <input value={hdr} onChange={(e)=> setHdr(e.target.value)} type="number" className="w-16 h-8 appearance-none focus:outline-white outline-1 bg-black text-white rounded-md p-2"/>
            </div>
        </div>
        <div>
