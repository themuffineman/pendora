...
const EarningsSummary = () => {
  return (
    <div className='rounded-md border p-4 flex-col flex w-72'>
        <div className='flex justify-between items-center w-full h-max p-2'>
            <p className="text-md tracking-tight font-medium">Total Revenue</p>
