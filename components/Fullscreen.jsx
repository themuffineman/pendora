...
import { setFullscreen } from '@/utils/globalVar'
...
const Fullscreen = () => {
  ...
  return (
    <div className={`w-full items-center justify-between sticky top-0 left-0 bg-black p-4 ${path == '/dashboard'? 'hidden' : 'flex'}`}>
        ...
        <svg onClick={()=> {setFullscreen()}} className="fill-white bg-none rounded-sm p-1 hover:fill-white hover:bg-black inline size-8 cursor-pointer" xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" ><path d="M120-120v-200h80v120h120v80H120Zm520 0v-80h120v-120h80v200H640ZM120-640v-200h200v80H200v120h-80Zm640 0v-120H640v-80h200v200h-80Z"/></svg>
    </div>
  )
}
